...
class GraphQL::Dataloader
  ...
  #
  # source://graphql//lib/graphql/dataloader.rb#146
  ...
  #
  # source://graphql//lib/graphql/dataloader.rb#104
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader.rb#163
  def clear_cache; end
  ...
  #
  # source://graphql//lib/graphql/dataloader.rb#83
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader.rb#75
  def nonblocking?; end

  # @api private
  #
  # source://graphql//lib/graphql/dataloader.rb#154
  def queue_pending_source(source); end

  # @param trace_query_lazy [nil, Execution::Multiplex]
  #
  # source://graphql//lib/graphql/dataloader.rb#209
  def run(trace_query_lazy: T.unsafe(nil)); end

  # source://graphql//lib/graphql/dataloader.rb#254
  def run_fiber(f); end
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader.rb#97
  def set_fiber_variables(vars); end

  # source://graphql//lib/graphql/dataloader.rb#263
  def spawn_fiber; end

  # source://graphql//lib/graphql/dataloader.rb#123
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader.rb#137
  def yield(source = T.unsafe(nil)); end

  private

  # source://graphql//lib/graphql/dataloader.rb#338
  def calculate_fiber_limit; end

  # source://graphql//lib/graphql/dataloader.rb#376
  def dequeue_pending_source; end

  # source://graphql//lib/graphql/dataloader.rb#367
  def drain_pending_sources; end

  # Returns true if anything was actually enqueued
  #
  # source://graphql//lib/graphql/dataloader.rb#291
  def enqueue_next_pending_lazies(lazies_at_depth); end

  # source://graphql//lib/graphql/dataloader.rb#349
  def join_queues(prev_queue, new_queue); end

  # source://graphql//lib/graphql/dataloader.rb#305
  ...
  # source://graphql//lib/graphql/dataloader.rb#355
  def spawn_job_fiber(trace); end

  # source://graphql//lib/graphql/dataloader.rb#383
  def spawn_source_fiber(trace); end

  # source://graphql//lib/graphql/dataloader.rb#329
...
class GraphQL::Dataloader::AsyncDataloader < ::GraphQL::Dataloader
  # @return [AsyncDataloader] a new instance of AsyncDataloader
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#21
  def initialize(*_arg0, **_arg1, &_arg2); end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#177
  def active_run; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#168
  def append_job(callable = T.unsafe(nil), &block); end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#29
  def create_pending_run; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#173
  def lazy_at_depth(depth, lazy); end

  # @api private
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#27
  def pending_sources; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#216
  def run(trace_query_lazy: T.unsafe(nil)); end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#181
  def run_isolated; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#34
  def yield(source = T.unsafe(nil)); end

  private

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#265
  ...
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#312
  def spawn_tasks(run, mode, condition, pending_work, num_tasks); end

  class << self
    # source://graphql//lib/graphql/dataloader/async_dataloader.rb#11
    def install_graphql_methods; end

    # source://graphql//lib/graphql/dataloader/async_dataloader.rb#6
    def use(*_arg0, **_arg1, &_arg2); end
  end
end

# source://graphql//lib/graphql/dataloader/async_dataloader.rb#47
class GraphQL::Dataloader::AsyncDataloader::Run
  # @return [Run] a new instance of Run
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#48
  def initialize(dataloader, total_fiber_limit, jobs_fiber_limit); end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#109
  def check_error!; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#82
  def close_queues; end

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#150
  ...
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#105
  def expect_resumes(count); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#99
  def has_bandwidth?; end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#95
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#74
  ...
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#116
  def new_queues(mode); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#91
  def quiesced?; end
  ...
  # Sets the attribute root_task
  #
  # @param value the value to set the attribute root_task to.
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#70
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#146
  def running?; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#78
  ...
  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#87
  def wait_for_activity; end

  private

  # source://graphql//lib/graphql/dataloader/async_dataloader.rb#161
...
class GraphQL::Dataloader::Source
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader/source.rb#183
  def clear_cache; end
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#59
  def load(value); end
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#72
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader/source.rb#126
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#44
  def normalize_fetch_key(value); end

  # Returns the value of attribute pending.
  #
  # source://graphql//lib/graphql/dataloader/source.rb#188
  def pending; end

  # @return [Boolean] True if this source has any pending requests for data.
  #
  # source://graphql//lib/graphql/dataloader/source.rb#118
  def pending?; end
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#32
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader/source.rb#137
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#205
...
# source://graphql//lib/graphql/dataloader/source.rb#99
...
class GraphQL::Execution::FieldResolveStep
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#108
  def add_graphql_error(result, key, err, return_type: T.unsafe(nil)); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#608
  def add_non_null_error(is_from_array); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#386
  ...
  #
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#189
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#601
  def authorized_finished(step); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#169
  def build_arguments; end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#157
  def build_errors_result(errors, single_error); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#510
  def build_leaf_result(result_h, result_key, field_result, return_type, ctx, is_from_array); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#451
  def build_results; end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#82
  def call; end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#540
  def enqueue_next_steps; end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#196
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#503
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#128
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#617
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#64
  def sync(lazy); end
  ...
  # source://graphql//lib/graphql/execution/field_resolve_step.rb#623
  def build_graphql_result(graphql_result, key, field_result, return_type, is_nn, is_list, is_from_array); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#792
  def error_instance_array(size, err_prototype); end

  # source://graphql//lib/graphql/execution/field_resolve_step.rb#686
...
class GraphQL::Execution::Finalize
  ...
  # source://graphql//lib/graphql/execution/finalize.rb#55
  def run; end

  private

  # source://graphql//lib/graphql/execution/finalize.rb#173
  def check_list_result(result_arr, inner_type, ast_selections); end

  # source://graphql//lib/graphql/execution/finalize.rb#97
  def check_object_result(result_h, parent_type, ast_selections); end

  # source://graphql//lib/graphql/execution/finalize.rb#92
  def finalizers(result_value, key); end

  # source://graphql//lib/graphql/execution/finalize.rb#77
...
class GraphQL::Execution::Interpreter::Runtime
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#659
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#552
  def continue_value(value, field, is_non_null, ast_node, result_name, selection_result); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#540
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#884
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#1001
  def lazy?(object); end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#799
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#497
...
# @api private
#
# source://graphql//lib/graphql/execution/interpreter/runtime.rb#551
...
class GraphQL::Execution::PrepareObjectStep
  ...
  # source://graphql//lib/graphql/execution/prepare_object_step.rb#80
  def authorize; end

  # source://graphql//lib/graphql/execution/prepare_object_step.rb#44
  def call; end

  # source://graphql//lib/graphql/execution/prepare_object_step.rb#113
...
class GraphQL::Execution::Runner
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/runner.rb#395
  def directives_include?(query, ast_selection); end

  # source://graphql//lib/graphql/execution/runner.rb#416
...
class GraphQL::Execution::SelectionsStep
  ...
  # source://graphql//lib/graphql/execution/selections_step.rb#30
  def call; end
  ...
  # source://graphql//lib/graphql/execution/selections_step.rb#24
  def graphql_objects; end

  # Returns the value of attribute killed.
  #
  # source://graphql//lib/graphql/execution/selections_step.rb#22
  def killed; end

  # Sets the attribute killed
  #
  # @param value the value to set the attribute killed to.
  #
  # source://graphql//lib/graphql/execution/selections_step.rb#22
...
class GraphQL::ExecutionError < ::GraphQL::RuntimeError
  ...
  #
  # source://graphql//lib/graphql/execution_error.rb#42
  def to_h; end
end
...
module GraphQL::Schema::BuildFromDefinition::Builder
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#451
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#377
  def build_deprecation_reason(directives); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#490
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#516
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#502
  def build_interface_type(interface_type_definition, type_resolver, base_type); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#434
  def build_interfaces(type_class, interface_names, type_resolver); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#421
  def build_object_type(object_type_definition, type_resolver, base_type); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#558
  def build_resolve_type(lookup_hash, directives, missing_type_handler); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#387
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#545
  ...
  # @return void
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#297
...
class GraphQL::Schema::Directive < ::GraphQL::Schema::Member
  ...
  # source://graphql//lib/graphql/schema/directive.rb#280
  def assert_has_location(location); end

  # source://graphql//lib/graphql/schema/directive.rb#243
...
# source://graphql//lib/graphql/schema/directive.rb#218
...
# source://graphql//lib/graphql/schema/directive.rb#214
...
class GraphQL::Schema::Wrapper
  ...
  # source://graphql//lib/graphql/schema/wrapper.rb#29

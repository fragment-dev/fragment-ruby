...
class HTTP::Client
  ...
  #
  # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/client.rb#7
  ...
  # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/client.rb#13
...
class HTTP::Request
  ...
  # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/request.rb#5
...
class HTTP::Response
  ...
  # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/response.rb#5
  def to_webmock; end
  ...
  # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/response.rb#83
  def reset_body_to_allow_it_to_be_streamed!(webmock_response); end

  class << self
    # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/response.rb#58
    def build_http_rb_response_body_from_webmock_response(webmock_response); end

    # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/response.rb#26
    def from_webmock(request, webmock_response, request_signature = T.unsafe(nil)); end

    # source://webmock/3.24.0/lib/webmock/http_lib_adapters/http_rb/response.rb#71

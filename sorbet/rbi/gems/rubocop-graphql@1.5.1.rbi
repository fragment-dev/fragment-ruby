...
class RuboCop::Cop::GraphQL::ResolverMethodLength < ::RuboCop::Cop::Base
  ...
  # @return [Boolean]
  #
  # source://rubocop-graphql//lib/rubocop/cop/graphql/resolver_method_length.rb#39
  def field_is_defined?(node); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/resolver_method_length.rb#46
